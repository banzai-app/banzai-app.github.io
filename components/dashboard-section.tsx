  ...
  return (
    <section className="py-0 sm:py-0 lg:py-0 lg-px-6 bg-white overflow-visible">
      <div className="container mx-auto px-4 sm:px-0 lg:px-8 lg:pb-36 lg:mx-48">
        <div className="relative flex flex-col lg:flex-row items-center lg:justify-between sm:min-h-[240px] lg:min-h-[350px] sm:mt-">
          ...
          <div className="relative xl:absolute md:right-16 xl:-right-8 sm:-right-8 xl:top-1/2 xl:-translate-y-1/2 flex justify-center xl:justify-end order-1 xl:order-2">
            <img 
              src="/product_1.png" 
              alt="Banzai App Interface"
              className="w-full min-w-[720px] h-auto xl:max-w-none xl:w-[1130px]"
            />
          </div>
        </div>
      </div>
